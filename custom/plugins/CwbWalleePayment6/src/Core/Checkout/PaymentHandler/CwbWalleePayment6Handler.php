...
namespace CwbWalleePayment6\Core\Checkout\PaymentHandler;
...
use CwbWalleePayment6\Core\Api\Transaction\Service\TransactionService;


/**
 * Class CwbWalleePayment6Handler
 *
 * @package CwbWalleePayment6\Core\Checkout\PaymentHandler
 */
class CwbWalleePayment6Handler implements AsynchronousPaymentHandlerInterface {
	...
	/**
	 * CwbWalleePayment6Handler constructor.
	 *
