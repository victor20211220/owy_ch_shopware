...
use CwbWalleePayment6\Core\Api\PaymentMethodConfiguration\Service\PaymentMethodConfigurationService;
...
class PaymentMethodConfigurationCommand extends Command {
	...
	{
		$output->writeln('Fetch CwbWalleePayment6 space available payment methods...');
	...
	{
		$this->setDescription('Fetches CwbWalleePayment6 space available payment methods.')
			 ->setHelp('This command fetches CwbWalleePayment6 space available payment methods.');
	}
