...
namespace CwbWalleePayment6\Core\Api\PaymentMethodConfiguration\Entity;
 ...
 *
 * @package CwbWalleePayment6\Core\Api\PaymentMethodConfiguration\Entity
 */
class PaymentMethodConfigurationEntityDefinition extends EntityDefinition {

	public const ENTITY_NAME = 'cwb_wallee_payment6_method_configuration';
