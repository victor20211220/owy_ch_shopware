...
namespace CwbWalleePayment6\Core\Api\WebHooks\Service;
 ...
 *
 * @package CwbWalleePayment6\Core\Api\WebHooks\Service
 */
class WebHooksService {
	 ...
	 *
	 * @return \CwbWalleePayment6\Core\Api\WebHooks\Service\WebHooksService
	 */
	...
	protected function installListeners(): array
	{
		...
		try {
			...
			/**
			 * @var \CwbWalleePayment6\Core\Api\WebHooks\Struct\Entity $data
			 */
