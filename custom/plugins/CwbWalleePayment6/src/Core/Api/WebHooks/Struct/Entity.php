...
namespace CwbWalleePayment6\Core\Api\WebHooks\Struct;
 ...
 * Class Entity
 *
 * @package CwbWalleePayment6\Core\Api\WebHooks\Struct
 */
class Entity extends Struct {
	...
	/**
	 * @param int $id
	 * @return \CwbWalleePayment6\Core\Api\WebHooks\Struct\Entity
	 */
