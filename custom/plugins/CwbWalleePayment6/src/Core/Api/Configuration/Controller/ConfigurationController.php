...
namespace CwbWalleePayment6\Core\Api\Configuration\Controller;
 ...
 *
 * This class handles web calls that are made via the CwbWalleePayment6 settings page.
 *
 * @package CwbWalleePayment6\Core\Api\Config\Controller
...
class ConfigurationController extends AbstractController {
	...
	/**
	 * Set CwbWalleePayment6 as the default payment for a give sales channel
	 *
	...
	{
		/**
		 * @var \CwbWalleePayment6\Core\Api\OrderDeliveryState\Service\OrderDeliveryStateService $orderDeliveryStateService
		 */
