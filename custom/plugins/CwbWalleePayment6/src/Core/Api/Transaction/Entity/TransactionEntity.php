...
namespace CwbWalleePayment6\Core\Api\Transaction\Entity;
...
use CwbWalleePayment6\Core\Api\Refund\Entity\RefundEntityCollection;

/**
 * Class TransactionEntity
 *
 * @package CwbWalleePayment6\Core\Api\Transaction\Entity
 */
class TransactionEntity extends Entity {
	...
	/**
	 * @var \CwbWalleePayment6\Core\Api\Refund\Entity\RefundEntityCollection
	 */
	protected $refunds;
	...
	/**
	 * @return \CwbWalleePayment6\Core\Api\Refund\Entity\RefundEntityCollection|null
	 */
	...
	/**
	 * @param \CwbWalleePayment6\Core\Api\Refund\Entity\RefundEntityCollection $refunds
	 */
