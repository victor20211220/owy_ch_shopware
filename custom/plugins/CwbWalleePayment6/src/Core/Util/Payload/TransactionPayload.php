...
namespace CwbWalleePayment6\Core\Util\Payload;
 ...
 *
 * @package CwbWalleePayment6\Core\Util\Payload
 */
class TransactionPayload extends AbstractPayload
{
	 ...
	 * @param \CwbWalleePayment6\Core\Util\LocaleCodeProvider $localeCodeProvider
	 * @param \Shopware\Core\System\SalesChannel\SalesChannelContext $salesChannelContext
	 * @param \CwbWalleePayment6\Core\Settings\Struct\Settings $settings
	 ...
	 * @param string $id
	 *
	 * @return \CwbWalleePayment6\Core\Api\PaymentMethodConfiguration\Entity\PaymentMethodConfigurationEntity
	 */
	protected function getPaymentConfiguration(string $id): PaymentMethodConfigurationEntity
	{
		$criteria = (new Criteria([$id]));

		return $this->container->get('cwb_wallee_payment6_method_configuration.repository')
