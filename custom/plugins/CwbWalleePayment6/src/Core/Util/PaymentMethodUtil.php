...
namespace CwbWalleePayment6\Core\Util;
...
use CwbWalleePayment6\Core\Checkout\PaymentHandler\CwbWalleePayment6Handler;

/**
 * Class PaymentMethodUtil
 *
 * @package CwbWalleePayment6\Core\Util
 */
class PaymentMethodUtil {
	...
	{
		$paymentMethodIds = $this->getCwbWalleePayment6MethodIds($context);
	 ...
	 * @return array
	 */
	public function getCwbWalleePayment6MethodIds(Context $context): array
	{
	...
	protected function getSystemPaymentMethodIds(Context $context): array
	{
		$criteria = (new Criteria())
			->addFilter(new NotFilter(
				...
				[
					new EqualsFilter('handlerIdentifier', CwbWalleePayment6Handler::class),
				]
			));
