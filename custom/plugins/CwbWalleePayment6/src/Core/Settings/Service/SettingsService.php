...
namespace CwbWalleePayment6\Core\Settings\Service;

use Psr\Log\LoggerInterface;
use Shopware\Core\System\SystemConfig\SystemConfigService;
use CwbWalleePayment6\Core\Settings\Struct\Settings;


/**
 * Class SettingsService
 *
 * @package CwbWalleePayment6\Core\Settings\Service
 */
class SettingsService {
	 ...
	 */
	public const SYSTEM_CONFIG_DOMAIN                       = 'CwbWalleePayment6.config.';
	 ...
	 *
	 * @param string|null $salesChannelId
	 * @return \CwbWalleePayment6\Core\Settings\Struct\Settings|null
	 */
	 ...
	 *
	 * @param string|null $salesChannelId
	 * @return \CwbWalleePayment6\Core\Settings\Struct\Settings
	 */
