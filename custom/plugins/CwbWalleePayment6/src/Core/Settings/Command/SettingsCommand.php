...
namespace CwbWalleePayment6\Core\Settings\Command;
 ...
 * @internal
 * @package CwbWalleePayment6\Core\Settings\Command
 */
class SettingsCommand extends Command {
	...
	{
		$output->writeln('Set CwbWalleePayment6 settings...');
	...
	{
		$this->setDescription('Sets CwbWalleePayment6 settings.')
			 ->setHelp('This command updates CwbWalleePayment6 settings for all SalesChannels.')
			 ->addOption(
