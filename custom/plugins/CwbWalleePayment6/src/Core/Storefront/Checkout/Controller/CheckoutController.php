...
namespace CwbWalleePayment6\Core\Storefront\Checkout\Controller;
 ...
 *
 * @package CwbWalleePayment6\Core\Storefront\Checkout\Controller
 *
...
class CheckoutController extends StorefrontController {
	...
	public function pay(SalesChannelContext $salesChannelContext, Request $request): Response
	{
		...
		return $this->renderStorefront(
			'@CwbWalleePayment6/storefront/page/checkout/order/wallee.html.twig',
			['page' => $page]
		);
	}
