...
namespace CwbWalleePayment6\Core\Storefront\Checkout\Struct;
 ...
 *
 * @package CwbWalleePayment6\Storefront\Checkout\Struct
 */
class CheckoutPageData extends Struct {
	 ...
	 * @return \CwbWalleePayment6\Core\Storefront\Checkout\Struct\CheckoutPageData
	 */
