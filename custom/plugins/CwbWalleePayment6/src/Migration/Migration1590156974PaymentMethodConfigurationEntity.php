...
class Migration1590156974PaymentMethodConfigurationEntity extends MigrationStep {
	...
	public function update(Connection $connection): void
	{
		$connection->executeStatement('
            CREATE TABLE IF NOT EXISTS `cwb_wallee_payment6_method_configuration` (
              ...
              KEY `fk.wle_payment_method_configuration.payment_method_id` (`payment_method_id`),
              CONSTRAINT `fk.wle_payment_method_configuration.payment_method_id` FOREIGN KEY (`payment_method_id`) REFERENCES `payment_method` (`id`) ON DELETE CASCADE
