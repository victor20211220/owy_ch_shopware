...
class CbaxLexiconLatestEntriesCmsElementResolver extends AbstractCmsElementResolver
{
    ...
    {
        return 'cbax-lexicon-latest-entries';
    }
    ...
    public function enrich(CmsSlotEntity $slot, ResolverContext $resolverContext, ElementDataCollection $result): void
    {
        ...
        $entries = $this->getLatestLexiconEntries($salesChannelContext->getContext(), $salesChannelId, $limit);
        $data = new ArrayStruct($entries);
        $slot->setData($data);
    }

    private function getLatestLexiconEntries(Context $context, string $salesChannelId, int $limit = 3): ?array
    {
