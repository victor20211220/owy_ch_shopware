...
use Acris\StoreLocator\Core\Content\Cms\SalesChannel\Struct\StoreStruct;
...
class StoreLocatorPageResolver extends AbstractCmsElementResolver
{
    ...
    public function enrich(CmsSlotEntity $slot, ResolverContext $resolverContext, ElementDataCollection $result): void
    {
        ...
        $mediaStoreIcon = null;
        $mediaHomeIcon = null;
        $store = new StoreStruct(null, null, null);
        ...
        $store->setGroups($this->storeLocatorGateway->getStoreGroups($resolverContext->getSalesChannelContext()));
